///주석처리한 코드는 모두 구버전용 코드이므로 오류를 발생시킴.
// 따라서 검증하지 않음
...
describe('RegisterPage.vue', () => {
  ...
  // 뷰와 뷰 cli 신 버전을 사용할 경우 책의 코드는 오류를 발생시킴. 따라서 위의 코드 사용
  // 참고: https://stackoverflow.com/questions/63931735/vue-v-model-bind-is-not-working-in-unit-test
